...
public  class RecyclerAdapterParent extends RecyclerView.Adapter<RecyclerAdapterParent.RecyclerViewHolder>{
    private Context mContext;
    private List<Post> teachers;
    private OnItemClickListener mListener;

    public RecyclerAdapterParent(Context context, List<Post> uploads) {
        mContext = context;
        teachers = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        Post currentTeacher = teachers.get(position);
